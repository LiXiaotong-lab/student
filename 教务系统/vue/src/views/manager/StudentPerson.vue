    ...
    <el-card style="width: 50%">
      <el-form :model="user" label-width="100px" style="padding-right: 50px">
        ...
        <el-form-item label="班级" prop="grade">
          <el-input v-model="user.grade" placeholder="班级" disabled></el-input>
        </el-form-item>
        ...
        <el-form-item label="出生日期" prop="birthday">
          <el-input v-model="user.birthday" placeholder="出生日期" ></el-input>
        </el-form-item>
        ...
        <el-form-item label="家庭地址" prop="address">
          <el-input v-model="user.address" placeholder="家庭地址"></el-input>
        </el-form-item>
        <el-form-item label="入学日期" prop="admissionDate">
          <el-input v-model="user.admissionDate" placeholder="入学日期" disabled></el-input>
        </el-form-item>
        <el-form-item label="毕业日期" prop="graduationDate">
          <el-input v-model="user.graduationDate" placeholder="毕业日期" disabled></el-input>
        </el-form-item>
