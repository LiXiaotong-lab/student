  ...
  <div class="manager-container">
    ...
    <div class="manager-header">
      <div class="manager-header-left">
        <img src="@/assets/imgs/logo.png" style="border-radius: 1000px" />
    ...
    <div class="manager-main">
      ...
      <div class="manager-main-left">
        <el-menu
          ...
          <el-submenu index="tv">
            <template slot="title">
              <i class="el-icon-menu"></i><span>视频&直播</span>
            </template>
            <el-menu-item index="/video">精彩视频</el-menu-item>
            <el-menu-item index="/live">校园直播</el-menu-item>
          </el-submenu>
          <!-- ------------------------------------------------------ -->
          <el-submenu index="info">
            ...
            <el-menu-item index="/arrange">教师开课信息</el-menu-item
            ><el-menu-item index="/timetable">选课信息</el-menu-item>
          </el-submenu>
          <!-- ------------------------------------------------------ -->
